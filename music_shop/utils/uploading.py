...
class ImageUploadHelper:
    ...
    def __init__(self, field_name_to_combine, instance, filename: str, upload_postfix):
    ...
    @classmethod
    def get_field_name_to_combine_and_upload_postfix(cls, klass: str):
        field_to_combine = cls.FIELD_COMBINE_MAP[klass]['field']
        upload_postfix = cls.FIELD_COMBINE_MAP.get(
            'upload_postfix', cls.FIELD_COMBINE_MAP['default']['upload_postfix']
        )
...
def upload_function(instance, filename):
    ...
    field_to_combine, upload_postfix = ImageUploadHelper.get_field_name_to_combine_and_upload_postfix(instance.__class__.__name__)
